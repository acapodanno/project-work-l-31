...
| **Medico** (`DOCTOR`) | Specialista della clinica | Dichiarare la propria disponibilità (slot singoli o in serie); gestire il calendario e lo stato delle visite; leggere i referti dei propri appuntamenti e aggiungervi le note cliniche; prescrivere terapie; consultare lo storico dei pazienti; creare una visita per un paziente (pulsante «Nuovo appuntamento»); aggiornare il proprio profilo |
| **Supporto** (`SUPPORT`) | Personale amministrativo/IT | Vedere tutte le visite e tutti i ticket; cambiare lo stato di visite e ticket; creare medici e pazienti; consultare le statistiche generali; creare visite per conto di un paziente — **solo tramite API**: nell'interfaccia la voce «Prenota Visita» è raggiungibile, ma il form prenota sempre per il profilo dell'utente collegato e il Supporto non ne ha uno ([cap. 9, L15](./9-Valutazione_Risultati.md#limiti-noti)) |
